package utils
{
    ...
    {
        private static var followerSin:Number;
        private static var followerCos:Number;
        private static var i:int;
        private static var ax:Number;
        private static var ay:Number;
        private static var primeCos:Number;
        private static var primeSin:Number;
        private static var fx:Number;
        private static var fy:Number;
        private static var w:Number;
        private static var h:Number;
        private static var mon:uint;
        /**
         ...
         */
        public static function collisionDetect(primeRect:Rectangle,primeRadian:Number,followerRect:Rectangle,followerRadian:Number,lelvel:uint = 0):Boolean{
...
//			trace("primeRect",primeRect,"primeRadian",primeRadian,"followerRect",followerRect,"followerRadian",followerRadian,"mon",mon)
         ...
         * @param mRec
         */
        private static function calculateFinalXY(mx:Number,my:Number,mRec:Rectangle,pRec:Rectangle):void{
